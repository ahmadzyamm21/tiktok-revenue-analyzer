...
document.addEventListener('DOMContentLoaded', () => {
        ...
        if (orderPayouts) {
            Object.keys(orderPayouts).forEach(orderId => {
                ...
                if (!agg.uniqueOrders.has(orderId)) {
                    ...
                    // Admin fee breakdown
                    agg.komisiDinamis += (payoutInfo.komisiDinamis || 0);
    ...
    function calculateMetrics() {
        ...
        revenueLogs.forEach(log => {
            ...
            totalKomisiDinamis += (log.komisiDinamis || 0);
        ...
        filteredDisplayItems.forEach((item, idx) => {
            ...
            rowsHtml.push(`
                <tr style="border-bottom: 1px solid var(--border-color);">
                    ...
                    <td style="padding: 12px 8px;"><span class="text-muted font-mono" style="font-size: 11px;">${(payoutInfo && payoutInfo.associatedOrderId) ? payoutInfo.associatedOrderId : item.orderId}</span></td>
